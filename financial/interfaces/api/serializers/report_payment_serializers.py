...
class ReportAmountPaymentResponseSerializer(serializers.Serializer):
    def to_representation(self, payload):
        return payload


class ReportAmountPaymentOpenResponseSerializer(serializers.Serializer):
    def to_representation(self, payload):
        return payload
...
class ReportForecastAmountValueResponseSerializer(serializers.Serializer):
    def to_representation(self, payload):
        return payload


class ReportMetricsResponseSerializer(serializers.Serializer):
    def to_representation(self, payload):
        return payload
...
class ReportBalanceProjectionResponseSerializer(serializers.Serializer):
    def to_representation(self, payload):
        return payload
