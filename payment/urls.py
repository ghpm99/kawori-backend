...
urlpatterns = [
    ...
    path("statement/anomalies", views.statement_anomalies_view, name="financial_statement_anomalies"),
    ...
    path("csv-ai-normalize/", views.csv_ai_normalize_view, name="financial_csv_ai_normalize"),
    path("csv-ai-reconcile/", views.csv_ai_reconcile_view, name="financial_csv_ai_reconcile"),
    path("ai-tag-suggestions/", views.ai_tag_suggestions_view, name="financial_ai_tag_suggestions"),
